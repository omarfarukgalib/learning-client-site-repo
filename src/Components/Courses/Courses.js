...
const Courses = () => {
    ...
    <div>
        <Link to="/courses/:id"><div className='mt-2 font-bold text-orange-700'>
        ...
        <div className='mt-2 font-bold text-orange-700'>
            <p>Apache</p>
      <Link to="/courses/:id">  <div className='font-semibold'>
            <p></p>
       ...
       <Link to="/courses/:id"> <div className='mt-2 font-bold text-orange-700'>
        ...
        <Link to="/courses/:id"><div className='mt-24 font-bold text-orange-700'>
            <p className=''>Software Development</p>
        <img className="mt-2 rounded-xl" src={logo1} alt="" />
        </div></Link>
      <Link to="/courses/:id">  <div className='mt-2 font-bold text-orange-700'>
       ...
       <Link to="/courses/:id"> <div className='mt-2 font-bold text-orange-700'>
        ...
        <Link to="/courses/:id"><div className='mt-2 text-orange-700 font-bold'>
                <p>Apache</p>
                <img className=" rounded-xl mt-2" src={logo2} alt="" />
            </div></Link>
        </div>
